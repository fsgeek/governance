...
- *Resolved 2026-05-02:* Does "silence-manufacture" survive Section 6's vocabulary co-optation analysis? The term has unusual structural resistance: the pattern it names *is* the production of substitute artifacts occupying positions where architectural change should be, so any documentary response to a silence-manufacture diagnosis enacts the pattern rather than rebutting it. Co-opted usage is therefore detectable on the term's own grounds. The resistance is at the structural level, not a guarantee of practical adoption — institutions can still adopt vocabulary without discipline, and the term can still drift into a synonym for "compliance failure." Section 6 paragraph "Silence-manufacture is unusually co-optation-resistant, but only at the structural level" carries the argument.
...
7. **Vocabulary co-optation analysis** (Section 6): does "silence-manufacture" survive co-optation pressure? *Resolved 2026-05-02. The term has unusual structural co-optation resistance because the pattern it names is the production of substitute artifacts; documentary responses to a silence-manufacture diagnosis enact the pattern rather than rebut it, so co-opted usage is detectable on the term's own grounds. Resistance is structural, not a guarantee of practical adoption. Section 6 paragraph added under "Uncertainties about the frame."*
