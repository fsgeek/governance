...
%       4.1.3  Relationship to decoupling/audit society  sec:diagnostics:silence-manufacture:decoupling
%       4.1.4  Mapping the three earned positions        sec:diagnostics:silence-manufacture:mapping-positions
%       4.1.5  What silence-manufacture predicts         sec:diagnostics:silence-manufacture:predictions
...
%   Section 5  The Evidence Request                      sec:request
%     (file: section-request.tex -- named, not numbered, to avoid renaming
%      section5..7 when inserted; \input order sets the number)
%     5.1  The eight fields                              sec:request:fields
%     5.2  A worked request                              sec:request:worked
%   Section 6  Provisional Evidentiary Capabilities      sec:primitives
%     6.1  Revision-aware temporal capture               sec:primitives:temporal-capture
%     6.2  Evidence binding and exportability            sec:primitives:evidence-binding
%     6.3  Non-collapsing uncertainty representation     sec:primitives:confidence-characterization
%     6.4  Technical-change monitoring                   sec:primitives:technical-change
%     6.5  Institutional-conformance monitoring          sec:primitives:institutional-conformance
%     6.6  What the capabilities contribute              sec:primitives:compound
%   Section 7  Honest Uncertainties                      sec:uncertainties
%     7.1  Scope of the frame
%     7.2  Conditions of examination
%     7.3  Architectural boundaries
%     7.4  Who moves first                               sec:uncertainties:first-move
%       7.4.1  An illustrative voluntary pathway         sec:uncertainties:first-move:voluntary-pathway
%     7.5  Theory of effect
%   Section 8  Conclusion                                sec:implications
% =====================================================================
...
\author{Tony Mason\thanks{Affiliations listed for identification only; this work was conducted independently and does not represent either institution.}\\
  Instructional Associate, Georgia Institute of Technology\\
...
by being called an explanation. The \emph{evidentiary-substitution sequence}
names that structure neutrally; \emph{silence-manufacture} names instances in
which unavailable contradictory evidence helps an unsupported substitution
persist.
