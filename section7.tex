...
Silence-manufacture names the recurring inference gap: relevant evidence is
...
The three diagnostic techniques turn that distinction into an examination
posture. Empty-chair enumeration identifies whose interest depends on an
...
removed and what it infers from the resulting gap. The four provisional
architectural requirements then identify properties that may help a system
answer those questions: tamper-evident temporal capture, evidence binding,
multidimensional characterization of support and insufficiency, and structural
drift typology. Their implementation, sufficiency, and tractability remain to
be tested.

For a regulator reading an AI governance record, the frame reduces to five
questions:
