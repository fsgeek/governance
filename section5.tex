...
systems. A bank remains responsible for ensuring that evidence warrants the
claims it makes, but it may be unable to obtain that evidence through a standard
product or contract. A vendor may provide a structured export; a bank may
maintain external bindings; an independent assessor may validate proprietary
components; or a compensating process may narrow the claim or reduce risk.
Sometimes no proportionate substitute exists. Product access without inspectable
evidence leaves a residual gap rather than creating procurement leverage.
...
No universal sequence among the five capabilities follows from the frame.
Priority depends on the proposition at risk, applicable obligations, existing
evidence, consequence and likelihood, vendor dependence, and feasible
alternatives. When no implementation or compensating process makes a material
claim supportable, risk acceptance, restricted use, replacement, or
discontinuation are institution-specific governance decisions rather than
technical outputs prescribed by this paper.
