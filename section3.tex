...
Regulation~Z requires standardized cost and term disclosures, including applicable annual-percentage-rate, finance-charge, and payment information \parencite{regZ1026}. Subject to exceptions and alternative credit-score disclosures, Regulation~V also requires a risk-based pricing notice when a consumer report contributes to granting covered consumer credit on materially less favorable terms than those available to a substantial proportion of the creditor's consumers \parencite{regV1022_72}. These notices communicate consequential facts, but generally not an individualized substantive account of why this applicant received this exact price.
