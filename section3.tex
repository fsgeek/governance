...
The remaining sections develop diagnostic techniques for applying this taxonomy (Section~\ref{sec:diagnostics}) and provisional architectural requirements that support those techniques (Section~\ref{sec:primitives}). The structural line is an evidentiary discipline: identify the object an artifact exposes and do not infer a different object without an inspectable warrant. Section~\ref{sec:uncertainties} states the limits on using that discipline in practice.
