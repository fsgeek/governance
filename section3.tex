...
Adverse-action law supplies an artifact and a proposition it must support. Risk-based pricing in consumer lending --- the interest rate, fees, and terms offered to an \emph{approved} applicant --- illustrates a different case: a potential policy and design gap. Existing law requires important disclosures in covered circumstances, but it does not generally create an individualized substantive reason-giving regime for the precise price offered that is equivalent to Regulation~B's specific-reasons regime for adverse action.

Regulation~Z requires standardized cost and term disclosures, including applicable annual-percentage-rate, finance-charge, and payment information \parencite{regZ1026}. Regulation~V also requires a risk-based pricing notice when a creditor uses a consumer report and, based in whole or in part on that report, grants covered consumer credit on materially less favorable terms than those available to a substantial proportion of its consumers, subject to specified exceptions and alternative credit-score disclosures \parencite{regV1022_72}. Those notices communicate consequential facts about the terms and the use of consumer-report information. They do not generally require the creditor to give an individualized substantive account of why this applicant received this exact price. The applicant receives a price and applicable disclosures; the applicant accepts or declines; the institution proceeds.
